...
public class Lexer
{
    ...
    public Lexer(CharSequence text, int startOffset, int length)
    {
        this.text = text;
    ...
    Token next() throws LexicalException
    {
        skipWhiteSpace();
    ...
    private Token parseString() throws LexicalException
    {
        char c = read();
        while(c != '"') {
            switch(c) {
    ...
    {
        return new Token(ttype, text, tokenStart, offset, line, column - offset + tokenStart);
    }
